---
title: ElimKeys Elytra Keyboard Review
date: 2026-07-15T10:09:33-07:00
...
![Underside of the keyboard.](DSCF3359.jpg)
...
One fun detail is that the hotswap socket for the  `5` key is rotated 180 degrees to make room for the USB-C connector. I had to do a similar thing when designing my [dabao keyboard](https://github.com/justinmklam/dabao) to make room for the integrated trackpoint. 

The Bluetooth module appears to be a [Minewsemi MS51SF1](https://store.minewsemi.com/product/bluetooth-modules-nrf52833-ms51sf1/), which was interesting because I hadn't encountered one in a keyboard before. It's a tiny module based on Nordic's nRF52833, with a 32-bit ARM Cortex-M4F CPU, 512 kB flash, and 128 kB RAM.

![Bluetooth module on the PCB.](DSCF3516.jpg)
...
![Power switch orientation matters during reassembly.](DSCF3547.jpg)

# Firmware

The Elytra uses [RMK](https://rmk.rs/), a Rust-based keyboard firmware, instead of the more common [QMK](https://qmk.fm/) or [ZMK](https://zmk.dev/), which is one of the more interesting technical choices that stood out to me.
...
It was also nice to see Vial features like Chordal Hold and Flow Tap available. These were only added to Vial in [0.7.4](https://get.vial.today/changelog/release-0.7.4.html) (released last year in July 2025, which was kind of a big deal) and made tap-hold behaviours much more usable, especially for people experimenting with home row mods or other timing-sensitive layouts.
