...
{{<img caption="Measuring maximum force before material failure, recorded on an iPhone 6 at 240 fps." src="pla-carnage.gif">}}
...
{{<img caption="Optimal layer orientation with respect to direction of primary load." src="layer-orientation.jpg" >}}
...
{{<img caption="Fence bracket repaired (left), and broken after a heavy windstorm (right)." src="broken fence.jpg" >}}
...
{{<img caption="Diagram showing the effect of heat treatment on the material's microstructure." link-text="3DSourced" link="https://www.3dsourced.com/rigid-ink/how-to-anneal-your-3d-prints-for-strength/" src="annealing_prints.jpg" >}}
...
{{<img caption="The first sample (non-annealed) had the lowest degree of crystallinity and highest deformation at 65°C. (Source: Turng and Srithep, 2014)" src="pla-annealing-paper.jpg" >}}
...
{{<img caption="Degree of crystallinity versus annealing time. (Source: Turng and Srithep, 2014)" src="crystallinity vs annealing time.JPG" >}}
...
{{<img caption="Annealing various 3D printed plastics in an oven. (Source: Thomas Sanlader, YouTube)" src="screencap-thomas-sanlader.JPG" >}}
...
{{<img caption="Boiling PLA for 10 minutes for extra strength. (Source: Joe Mike Terranella, YouTube)" src="screencap-terranella.JPG" >}}
...
{{<img caption="DIY sous vide controller hooked up to a kettle." src="IMG_20170318_130307.jpg" >}}
...
{{<img caption="Deprecated pennies were used to keep the samples submerged in the temperature controlled water bath." src="IMG_20170318_183551.jpg" >}}

{{<img caption="Test samples lined up for carnage." src="IMG_20170318_165409.jpg" >}}
...
{{<img caption="Overview of test setup. Camera is used to capture the scale measurement at peak force." src="IMG_20170319_164047.jpg" >}}
...
{{<img caption="Max applied force before failure at 0.2625 mm and 0.175 mm layer heights." src="data-layer height.JPG">}}
...
{{<img caption="Averaged data with error bars showing standard deviations." src="data-layer height avg.JPG">}}
...
{{<img caption="Quantifying the changes in each dimension after annealing." src="data-dimensional change.JPG">}}
...
{{<img caption="Detailed results showing the stress-strain curves for samples printed at varying layer heights. (Source: 3D Matter)" src="layerheightstressstrain.png">}}
